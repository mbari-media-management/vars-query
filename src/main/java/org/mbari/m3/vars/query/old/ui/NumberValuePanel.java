package org.mbari.m3.vars.query.old.ui;
...
import org.mbari.m3.vars.query.old.ui.db.MaxConstraint;
import org.mbari.m3.vars.query.old.ui.db.MinConstraint;
import org.mbari.m3.vars.query.old.ui.db.MinMaxConstraint;
...
public class NumberValuePanel extends AbstractValuePanel {
    ...
    public NumberValuePanel(String valueName) {
        ...
        setHgrow(spacer, Priority.NEVER);
        Region btnSpacer = new Region();
        btnSpacer.setMinWidth(10);
        setHgrow(btnSpacer, Priority.NEVER);
    ...
    private TextField getMinTextField() {
        if (minTextField == null) {
            ...
            setHgrow(minTextField, Priority.ALWAYS);
        }
        return minTextField;
    }
    ...
    private TextField getMaxTextField() {
        if (maxTextField == null) {
            ...
            setHgrow(maxTextField, Priority.ALWAYS);
        }
        return maxTextField;
    }
