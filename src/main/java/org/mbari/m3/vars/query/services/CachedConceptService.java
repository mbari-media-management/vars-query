...
public class CachedConceptService implements ConceptService {
    ...
    public CompletableFuture<Optional<Concept>> findDescendants(String name) {
        if (cache.containsKey(name)) {
            ...
            CompletableFuture<Optional<Concept>> f = conceptService.findDescendants(name);
    ...
    public CompletableFuture<Optional<Concept>> findAncestors(String name) {
        return conceptService.findAncestors(name);
    }
    ...
    public CompletableFuture<List<String>> findConceptNames(String name,
        ...
        return conceptService.findConceptNames(name, extendToParent, extendToSiblings,
                extendToChildren, extendToDescendants);
    }
